...
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile SearchAndDestroyChess.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = SearchAndDestroyChess1.0.0
DISTDIR = /home/richel/GitHubs/SearchAndDestroyChess/.tmp/SearchAndDestroyChess1.0.0
SUBTARGETS    =  \
		release \
		debug
...
Makefile: SearchAndDestroyChess.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
